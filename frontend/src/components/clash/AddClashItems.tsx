...
//       formData.append("clash_id", clashId.toString());
//       items.map((item) => {
//         if (item.image) {
...
//             className="hidden"
//             ref={imgRef1}
//             onChange={(e) => handleImageChage(e, 0)}
//           />

//           <div
//             className="w-full flex justify-ceter items-center 
//                 rounded-md border border-dashed p-2 h-[300px]"
...
//             className="hidden"
//             ref={imgRef2}
//             onChange={(e) => handleImageChage(e, 1)}
//           />

//           <div
//             className="w-full flex justify-ceter items-center rounded-md border border-dashed p-2 h-[300px]"
